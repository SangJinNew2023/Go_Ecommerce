...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error {
	...
	update2 := bson.M{"$push":bson.M{"orders.$[].order_list": boson.M{"$each":getcartitems.UserCart}}}
...
func InstantBuyer(ctx context.Context, prodCollelction *mongo.Collection, productID, primitive.ObjectID, UserID string) error {
	id, err := primitive.ObjectIDFromHex(UserID)
